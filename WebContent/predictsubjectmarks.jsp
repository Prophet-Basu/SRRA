  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
	     <center>
			<input type="hidden" id="strID" value="<%=strID%>">	
		 
			<form action="SubjectPredictionSrv" method="post">
			
				<select name="semNo" id="semSelect" onchange="updateSubjectList()">
				...
				<div>
					<select id="subPredict" name="subPredict">
						<option value="0">Select Subject to Predict</option>
					
					</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/><br/><br/>
				</div>
			
				<h3>Choose Subjects</h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<!-- 	<button id="addButton" onclick="addsubj()">Add Subject</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
			<!-- 	<button id="delButton" onclick="delsubj()">Delete Subject</button><br/><br/> -->
				...
				<div id="singleSubjDiv">
					<select id="subjectSelect" name="subjs">
						<option value="0">Select Subject</option>
					
					</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="number" name="marks"><br/><br/><br/>
				</div>
