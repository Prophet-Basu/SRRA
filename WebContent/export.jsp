  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
	     <center>
			<form action="ExportTeacherExcelSrv">
				<input type="submit" value="Export Teacher Details">
			</form>
			<br/><br/>
			<b>OR</b><br/><br/>
			<%
				...
				ArrayList<String> sbList=sdao.fetchDistinctSessions(strID);
			%>
			<form action="ExportStudentExcelSrv">
				<select name="sesID">
				...
				<input type="submit" value="Export Student Details">
			</form>
