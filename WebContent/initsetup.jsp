 ...
 <body style="font-family:roboto;">
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div id="u134-wrapper">
	...
	<center>
		<a href="ConfigSrv">Configure Connection</a><br />
		<br /> <a href="initsetupsubject.jsp">Add Subject</a><br />
		<br /> <a href="initsetupsessions.jsp">Add Session</a><br />
		<br /> <a href="verifyteacher.jsp">Verify Teachers</a><br />
   ...
   <div id="u138-wrapper">
    <div class="pinned-colelem" id="u138"><!-- custom html -->
     <center>
		<a href="export.jsp">Export Data</a><br />
		<br /> <a href="teacherdetail.jsp">Teacher Details</a><br />
		<br /> <a href="promoteteacherrole.jsp">Give Admin Rights</a><br />
		<br /> <a href="verifysubjects.jsp">Verify Subjects</a><br />
