...
<%@page import="com.servlet.AddSessionSrv"%>
...
{
	var cnt=$('#secCount').val();
	$('#sectionNames').empty();
	for(i=1;i<=cnt;i++){
		var div_data='<input type="text" name="secName" placeholder="Section '+i+' Name">&nbsp;&nbsp;';
		$(div_data).appendTo('#sectionNames');
	}
}
</script>
   ...
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
	     <center>
			<form  method="post">
			&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="number" name="<%=AddSessionSrv.Parameters.SESSIONSTART%>" placeholder="Staring Year" required="required">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="number" name="<%=AddSessionSrv.Parameters.SESSIONEND%>" placeholder="Ending Year" required="required"><br/><br/>
			&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="number" name="<%=AddSessionSrv.Parameters.NOOFSECTIONS %>" id="secCount" onkeyup="generateSectionFields()" placeholder="Number of Sections" required="required">
				<div id="sectionNames"><br/><br/>
				
				</div>
				<input type="submit" formaction="AddSessionSrv?type=1" value="Add and Next"><br/><br/>
				<input type="submit" formaction="AddSessionSrv?type=2" value="Add and Finish">
			</form>
