  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
	     <center>
			<form action="TeacherPasswordChangeSrv" method="post">
			<input type="password" name="<%=TeacherPasswordChangeSrv.Parameters.OPASS %>" placeholder="Enter Old Password" required="required">
			
			<br/><br/>
			<input type="password" name="<%=TeacherPasswordChangeSrv.Parameters.NPASS %>" placeholder="Enter New Password" required="required">
			
			<br/><br/>
			<input type="password" name="<%=TeacherPasswordChangeSrv.Parameters.CNPASS %>" placeholder="Re-Enter New Password" required="required">
		...
		<%
		Object msgobj=session.getAttribute(TeacherPasswordChangeSrv.Parameters.MSG);
		if(msgobj!=null){
			String msg=(String)msgobj;
	%>
		<span style="color: green;font-size: 18px;font-weight: bold;"><%=msg %> </span><br/>
	<%
		session.removeAttribute(TeacherPasswordChangeSrv.Parameters.MSG);
		}
	%>
		</center>
	</div>
