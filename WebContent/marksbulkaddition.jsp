  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
		<center>
		<form action="MarksBulkSrv" method="post" enctype="multipart/form-data">
<!-- 	<form action="MarksBulkSrv" method="post" > -->
		<select name="sesID">
		<option value="0">Select Session</option>
		<%
			for(String ses:sesList){
		%>
		...
		<input type="file" name="file" size="" accept=".xls,.xlsx"/><br/><br/>
