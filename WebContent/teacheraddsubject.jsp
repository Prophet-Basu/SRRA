...
<%@page import="com.servlet.TeacherAddSubjectSrv"%>
...
function updateSelect()
{
	...
	$.ajax({
	    ...
	    success:function(data) {
	        ...
	        var d='<option value="0">Select Section</option>';
 ...
 <body style="font-family:roboto;">
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <%
	...
	ArrayList<String> slist=sdao.fetchDistinctSessions(strID);
	ArrayList<SubjectBean> sblist=sbdao.fetchAllStreamSubjects(strID);
%>
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
		...
		<select name="<%=TeacherAddSubjectSrv.Parameters.SESID %>" id="sessionSelect" onchange="updateSelect()">
		...
		<select id="sectionSelect" name="<%=TeacherAddSubjectSrv.Parameters.SECNAME%>">
			
		</select><br/><br/>
		<select name="<%=TeacherAddSubjectSrv.Parameters.SUBCODE %>" id="subjectSelect">
		<%for(SubjectBean sb:sblist) {%>
			<option value="<%=sb.getSubCode()%>"><%=sb.getSubCode() %> <%=sb.getSubName() %></option>
		<%} %>
		</select><br/><br/>
		<input type="submit" formaction="TeacherAddSubjectSrv?type=1" value="Add and Next"><br/>
		<input type="submit" formaction="TeacherAddSubjectSrv?type=2" value="Add and Finish"><br/>
			</form>
