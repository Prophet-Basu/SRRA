...
<%@page import="com.servlet.TeacherProfileUpdateSrv"%>
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
	     <center>
			<form action="TeacherProfileUpdateSrv" method="post">
			<input type="text" name="<%=TeacherProfileUpdateSrv.Parameters.NAME %>" value="<%=tbean.getTeacherName() %>" placeholder="Enter Name" required="required">
			
			<br/><br/>
			<input type="text" name="<%=TeacherProfileUpdateSrv.Parameters.ADDR %>" value="<%=tbean.getTeacherAddress() %>" placeholder="Enter Address" required="required">
			
			<br/><br/>
			<input type="text" name="<%=TeacherProfileUpdateSrv.Parameters.DOB %>" value="<%=tbean.getTeacherDOB() %>" placeholder="Enter D.O.B." required="required">
			
			<br/><br/>
			<input type="email" name="<%=TeacherProfileUpdateSrv.Parameters.EMAIL %>" value="<%=tbean.getTeacherEmail() %>" placeholder="Enter Email" required="required">
			
			<br/><br/>
			<input type="number" min="1000000000" max="9999999999" name="<%=TeacherProfileUpdateSrv.Parameters.MOB %>" value="<%=tbean.getTeacherMob() %>" placeholder="Enter Name" required="required">
			
			<br/><br/>
			<input type="text" name="<%=TeacherProfileUpdateSrv.Parameters.DESG %>" value="<%=tbean.getTeacherDesignation() %>" placeholder="Enter Name" required="required">
			
			<br/><br/>
			<input type="password" name="<%=TeacherProfileUpdateSrv.Parameters.PASS %>" placeholder="Enter Password" required="required">
		...
		<%
		Object msgobj=session.getAttribute(TeacherProfileUpdateSrv.Parameters.MSG);
		if(msgobj!=null){
			String msg=(String)msgobj;
	%>
		<span style="color: green;font-size: 18px;font-weight: bold;"><%=msg %> </span><br/>
	<%
			session.removeAttribute(TeacherProfileUpdateSrv.Parameters.MSG);
		}
	%>
