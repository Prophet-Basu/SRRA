...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "index.css"], "outOfDate":[]};
  ...
  <link rel="stylesheet" type="text/css" href="css/initsetup_my.css?crc=4020712053" id="pagesheet"/>
 ...
 <body style="font-family:roboto;">
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   %>
    <p>Hello <%=tbean.getTeacherName() %></p>
   </div>
   ...
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
     <center>
		<a href="teacherupdate.jsp">View/Update Profile</a><br/><br/>
		<a href="teacherpassword.jsp">Change Password</a><br/><br/>
		<a href="teacheraddsubject.jsp">Add Subjects Taught</a><br/><br/>
   ...
   <div id="u138-wrapper">
    <div class="pinned-colelem" id="u138"><!-- custom html -->
     <center>
		<a href="marksbulkaddition.jsp">Marks Upload</a><br/><br/>
		<a href="attendancehome.jsp">Maintain Attendance</a><br/><br/>
		<a href="studentcomparison.jsp">Compare Students</a><br/><br/>
   ...
   <div id="u142-wrapper">
    <div class="pinned-colelem" id="u142"><!-- custom html -->
     <center>
     
		<a href="bulkaddition.jsp">Bulk Addition</a><br/><br/>
		<a href="predictionhome.jsp">Prediction</a><br/><br/>
		<%
		
		if(tbean.getTeacherRole().equals("Admin")){
		%>
		<a href="initsetup.jsp">Setup</a><br/><br/>
		<%
		}
		%>
