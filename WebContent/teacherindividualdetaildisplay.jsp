...
<%
	...
	ArrayList<TeacherBean> tlist=tdao.fetchAllTeacher(Integer.parseInt(session.getAttribute("stream").toString()), ((TeacherBean)bean).getTeacherID());
%>
<!DOCTYPE html>
  ...
  <center>
	...
	<div id="ctn2">
		...
		%>
			...
			<td><%=tb.getTeacherAddress() %></td>
			<td><%=tb.getTeacherDOB()%></td>
			<td><%=tb.getTeacherMob()%></td>
			<td><%=tb.getTeacherEmail()%></td>
