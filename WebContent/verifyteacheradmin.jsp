...
function updateTeacherTable(){
	...
	$.ajax({
		...
		data: "<%=GenerateTeacherJSONSrv.Parameters.STRID%>="+dept+"&<%=GenerateTeacherJSONSrv.Parameters.CATEGORY%>="+'verify',
		dataType: 'json',
		cache: false,
		success:function(data){
	        ...
	        $.each(data.teacher, function (i, item) {
	           ...
	           '</td><td>' + "<a href='TeacherVerifySrv?teacherID="+item.teacherID+"' onclick='return confirm('Are you sure you want to edit details of this Subject?')'>Verify</a>" + 
	            '</td></tr>';
	        });
 ...
 <body>
  ...
  <center>
	<select name="" id="streamSelect" onchange="updateTeacherTable()">
...
<br/><br/>
<a href="admin.jsp">HOME</a><br/><br/><br/>
  </center>
  <br/><br/>
