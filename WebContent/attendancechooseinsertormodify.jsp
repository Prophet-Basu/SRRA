   ...
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
	     <center>
			...
			<form action="SetupAttendanceSrv" method="post">
				...
				<input type="radio" name="choice" value="Insert" checked="checked">Insert Attendance&nbsp;&nbsp;&nbsp;
				<input type="radio" name="choice" value="Modify">Modify Attendance
				<br/><br/>
