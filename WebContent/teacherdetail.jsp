  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
     <center>
		<br /> <a href="teacherindividualdetaildisplay.jsp">Teacher Individual Detail</a><br />
   ...
   <div id="u138-wrapper">
    <div class="pinned-colelem" id="u138"><!-- custom html -->
     <center>
		<br /> <a href="particularsemesterteacher.jsp">Teachers in a Particular Semester</a><br />
   ...
   <div id="u142-wrapper">
    <div class="pinned-colelem" id="u142"><!-- custom html -->
     <center>
		...
		<br /> <a href="particularsubjectteacher.jsp">Teachers Teaching a Particular Subject</a><br />
