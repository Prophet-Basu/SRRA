...
<%@page import="com.servlet.GenerateTeacherParticularSemesterJSONSrv"%>
...
<script type="text/javascript">
	...
	$.ajax({
		type:"GET",
		url:"GenerateTeacherParticularSemesterJSONSrv",
		data: "<%=GenerateTeacherParticularSemesterJSONSrv.Parameters.STRID%>="+dept+"&<%=GenerateTeacherParticularSemesterJSONSrv.Parameters.SEM%>="+semester,
		dataType: 'json',
		cache: false,
   ...
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
	     <center>
			...
			<input type="hidden" name=" "id="streamSelect" value="<%=Integer.parseInt((session.getAttribute("stream")).toString()) %>" >

<% 
		
		StreamBean sb = streamDao.fetchStreamDetails(Integer.parseInt((session.getAttribute("stream")).toString()));
		
%>

			
			<select name="" id="semSelect" onchange="updateTeacherTable">
			<option value="0">Select Semester</option>
			<%
				for(int i=1;i<=sb.getStrNoOfSem();i++){
			%>
