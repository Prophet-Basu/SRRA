 ...
 background-color: #2cc674;
  ...
  -o-border-radius: 15px;
	...
	function addsubj(){
		...
		var div = $('#singleSubjDiv').html();
		$("<div name=singleSubjDiv"+c+">"+div+"</div>").insertAfter('#singleSubjDiv');
		c=c+1;
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
	     <center>
			<form action="GPAPredictionSrv" method="post">
				<h3>Choose GPA to Predict: </h3>
				<select name="gpaPredict">
					<option value="0">Select GPA</option>
					<option value="sgpa1">Semester 1 GPA</option>
					<option value="sgpa2">Semester 2 GPA</option>
					<option value="sgpa3">Semester 3 GPA</option>
					<option value="sgpa4">Semester 4 GPA</option>
					<option value="sgpa5">Semester 5 GPA</option>
					<option value="sgpa6">Semester 6 GPA</option>
					<option value="sgpa7">Semester 7 GPA</option>
					<option value="sgpa8">Semester 8 GPA</option>
					<option value="ygpa1">Year 1 GPA</option>
					<option value="ygpa2">Year 2 GPA</option>
					<option value="ygpa3">Year 3 GPA</option>
					<option value="ygpa4">Year 4 GPA</option>
					<option value="dgpa">DGPA</option>
				</select>
				<br/><br/><br/>
				<h2>Choose and Enter GPA Scores</h2><br/><br/>
				<input type="button" id="addButton" onclick="addsubj()" value="Add Subject">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" id="addButton" onclick="delsubj()" value="Delete Subject">
			
				<div id="singleSubjDiv">
					<select id="subjectSelect" name="gpas">
						<option value="0">Select GPA</option>
						<option value="sgpa1">Semester 1 GPA</option>
						<option value="sgpa2">Semester 2 GPA</option>
						<option value="sgpa3">Semester 3 GPA</option>
					...
					<input type="text" name="marks"><br/><br/><br/>
				</div>
