...
function message(){
 ...
 <body style="font-family:roboto;">
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <%
	int strID=1;//(int)session.getAttribute(LoginSrv.Parameters.STREAM);
	SessionDao sdao=new SessionDaoImpl();
	ArrayList<String> sesList=sdao.fetchDistinctSessions(strID);
	%>
</head>
...
%>
	...
	<input type="hidden" name=" "id="teacherID" value="<%=msg%>" >
<%
	}
%>	
   ...
   <div id="u134-wrapper">
    <div class="pinned-colelem" id="u134"><!-- custom html -->
	     <center>
			<h1 style="font-size: x-large;color:grey">Student Bulk Addition</h1><br/><br/>
			<form action="StudentBulkSrv" method="post" enctype="multipart/form-data">
				<select name="sesID">
		<!-- 		<option>2013-2017</option> -->
				...
				<input type="file" name="file" size="60" accept=".xls,.xlsx,.csv"/><br/><br/>
				<input type="submit" value="Upload">
			</form>
			<br/><br/>
			<h1 style="font-size: x-large;color:grey">Teacher Bulk Addition</h1><br/><br/>
			<form action="TeacherBulkSrv" method="post" enctype="multipart/form-data">
				<input type="file" name="file" size="60" accept=".xls,.xlsx,.csv"/><br/><br/>
				<input type="submit" value="Upload">
			</form>
