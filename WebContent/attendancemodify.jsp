...
<%
	ArrayList<String> colList=(ArrayList<String>)session.getAttribute("COLLIST");
	ArrayList<ArrayList<String>> valList=(ArrayList<ArrayList<String>>)session.getAttribute("VALLIST");
	int arr[]=new int[colList.size()-2];
	int c=1;
%>
  ...
  <center>
	<table>
		...
		<th align="center">Update Attendance</th>
		<th align="center">Delete Attendance</th>
		</tr>
		
		<%for(ArrayList<String> alist:valList){ %>
		
		<tr>
		<form action="" method="post">
		
			<td align="center"><b><%=alist.get(0)%></b></td>
			<input type="hidden" name="attnDate" value="<%=alist.get(0)%>">
			<%for(int i=1;i<alist.size()-1;i++){ 
			if(alist.get(i).equals("1")){%>
			<td align="center"><input type="checkbox" name="studAttn" value="<%=colList.get(i)%>" checked="checked"></td>
			<%arr[i-1]++;}else{ %>
			<td align="center"><input type="checkbox" name="studAttn" value="<%=colList.get(i)%>"></td>
			<%}
			}
			%>
			
			<td align="center"><b><%=alist.get(alist.size()-1)%></b></td>
			<td align="center"><input type="submit" value="Update" formaction="UpdateAttendanceSrv"></td>
			<td align="center"><input type="submit" value="Delete" formaction="DeleteAttendanceSrv"></td>
		</form>
		</tr>
		...
		<tr>
		<td align="center"><b>Individual Attendance</b></td>
		<%for(int count:arr){ %>
