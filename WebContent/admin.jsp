  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div id="u134-wrapper">
	...
	<center>
		...
		<br /> <a href="initsetupstream.jsp">Add Stream</a><br />
		<br /> <a href="verifyteacheradmin.jsp">Verify Teachers</a><br />
	</center>
...
<!-- 		<br /> <a href="teacherdetail.jsp">Teacher Details</a><br /> -->
		<br /> <a href="promoteteacherroleadmin.jsp">Give Admin Rights</a><br />
		<br /> <a href="LogoutSrv">Logout</a><br />
		<br />
	</center>
</div>
   </div>
