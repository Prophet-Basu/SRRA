...
/**
 * Servlet implementation class TeacherVerifySrv
 */
@WebServlet("/TeacherVerifySrv")
public class TeacherVerifySrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TeacherVerifySrv() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(tdao.approveTeacher(teacherID, strID)){
