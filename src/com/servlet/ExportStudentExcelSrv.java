...
/**
 * Servlet implementation class ExportStudentExcelSrv
 */
@WebServlet("/ExportStudentExcelSrv")
public class ExportStudentExcelSrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExportStudentExcelSrv() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String filepath="D:\\";
		String msg=BulkExport.studentBulkExport(strID, sesID, filepath);
		if(msg.equals("-1")){
